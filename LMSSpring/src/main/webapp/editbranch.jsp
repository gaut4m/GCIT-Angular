...
<%
	...
	copies=(List<BCopies>)request.getAttribute("copies");
...
<div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-6  col-md-10  main">
          <h2 class="sub-header">Branch Management</h1>
			 ${message}
          <div class="row placeholders">
<h5>You have chosen to update Branch details of <%=branch.getBranchName() %> branch </h5>
...
<table align="center">
	...
	<%for(BCopies a: copies){ %>
		<tr>
			...
			<td align="center">+&nbsp;<input type="number"  id="addCopies" name="addCopies" value="" size="2">&nbsp;<input type="submit" value="UPDATE"></td>
			</form>
			</tr>
	<%} %>
