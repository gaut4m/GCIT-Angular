...
<div class="container-fluid">
      <div class="row">
        ...
        <br>
          <ul class="nav nav-sidebar">
            <li class="active"><a href="users">Overview <span class="sr-only">(current)</span></a></li>
            <li><a href="adduser">Add Borrower</a></li>
            <li><a href="viewusers">View Borrowers</a></li>
          </ul>
        </div>
        <div class="col-sm-6  col-md-10  main">
          <h1 class="sub-header">View Existing Borrowers</h1>
			 ${message}
	...
	<%for(Borrower b: br){ %>
		<tr>
			...
			<td align="center"><button type="button" onclick="javascript:location.href='edituser?cardNo=<%=b.getCardNo() %>'">EDIT</button></td>
