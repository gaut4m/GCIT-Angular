...
%>
<% 
LibrarianService lib =(LibrarianService)request.getAttribute("lib");
...
<div class="container-fluid">
    ...
    <input type="submit" value="Logout" />
        ...
        <div class="col-sm-6  col-md-10  main">
          <h1 class="sub-header">Check Out books From <%=branch.getBranchName() %> branch</h1>
			 ${message}
	...
	<%for(BCopies b: copies){ %>
		<tr>
			...
			<%if(b.getBook().getAuthors()!=null){for(Author a:b.getBook().getAuthors()){
				%>
			...
			<td ><input type="text" style="text-align:center;" id="noOfCopies" name="noOfCopies" value="<%=b.getNoofCopies()%>" size="3" readonly></td>
